...
<head>
    ...
    <title>{{ config('Femenil 2024', 'Femenil 2024') }}</title>
    ...
    <script src="{{ asset('assets/jquery/dist/jquery360.min.js') }}"></script>    
    ...
    <div id="app">
        ...
        <main class="py-3">
            ...
            <div class="container">
                @yield('cabecera')
                <hr>
                <h5 style="text-align-last: center; text-transform:uppercase">@yield('subtitulo','subtitulo') </h5>
                @yield('content')
            </div>
        </main>
    </div>
